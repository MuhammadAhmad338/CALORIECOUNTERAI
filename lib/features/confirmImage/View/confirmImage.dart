        ...
        child: Center(
          child: Column(
            mainAxisSize: MainAxisSize
                .max, // Ensures the Column takes only the space it needs
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius:
                        BorderRadius.circular(26.0), // Rounded corners
                  ),
                  child: ClipRRect(
                      borderRadius: BorderRadius.circular(
                          26.0), // Match the border radius
                      child: Image.file(
                        File(imagePath),
                        fit: BoxFit
                            .cover, // Ensures the image scales to fit nicely
                      )),
                ),
              ),
              const SizedBox(
              ...
              Padding(
                ...
                child: BarcodeCapturedImage(
                  buttonText: Const.confirmCapturedImageButton,
                  imagePath: imagePath,
      ...
      children: [
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            backgroundColor: CColors.lightgreyColor, // Light background color
            elevation: 0,
          ),
          child: Icon(
            icon,
